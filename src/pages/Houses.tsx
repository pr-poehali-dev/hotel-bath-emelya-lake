...
const HOUSES = [
  {
    ...
    description: "Уютный двухэтажный домик для отдыха в Башкирии. Внутри вас ждут две просторные спальни, гостиная и полностью оборудованная кухня. Собственная баня с обливным ведром — идеально для любителей контрастных процедур.",
  },
  {
    id: 3,
    ...
    description: "Просторный домик с собственной баней и большим деревянным чаном под открытым небом. Лежать в горячем чане, глядя на звёзды Башкирии — незабываемые ощущения. Уютная терраса, гостиная и полный комфорт для компании до 6 человек.",
  },
];
