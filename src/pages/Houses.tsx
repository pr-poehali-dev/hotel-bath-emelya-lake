...
const HOUSES = [
  {
    ...
    area: "80 м²",
    prices: { weekday: "6 000 р/сут", weekend: "8 300 р/сут", sunMon: "9 500 р/сут" },
    features: ["2 спальни", "Гостиная с камином", "Полностью оборудованная кухня", "Баня с обливным ведром", "Мангал и беседка", "Бесплатный Wi-Fi", "Парковка", "Смена белья"],
    description: "Уютный двухэтажный домик с панорамными видами на горы и лес. Внутри вас ждут две просторные спальни, гостиная с настоящим камином и полностью оборудованная кухня. Собственная баня с обливным ведром — идеально для любителей контрастных процедур.",
  },
  {
    id: 3,
    title: "Домик 3",
    ...
    area: "90 м²",
    prices: { weekday: "6 000 р/сут", weekend: "8 300 р/сут", sunMon: "9 500 р/сут" },
    features: ["2 спальни", "Гостиная с камином", "Полностью оборудованная кухня", "Баня с большим чаном", "Открытая веранда", "Мангал и беседка", "Бесплатный Wi-Fi", "Парковка"],
    description: "Просторный домик с собственной баней и большим деревянным чаном под открытым небом. Лежать в горячем чане, глядя на звёзды Башкирии — незабываемые ощущения. Терраса с видом на лес, камин в гостиной и полный комфорт для компании до 6 человек.",
  },
];
