...
const ROOMS = [
  {
    name: "Баня 1",
    desc: "Классическая русская баня на дровах, отдельный сруб, купель с холодной водой, терраса с видом на лес",
    price: "от 2 500 ₽/2 ч.",
    persons: "до 4 чел.",
    img: SAUNA_IMG,
    badge: "",
  ...
  {
    name: "Баня 2",
    desc: "Просторная баня с панорамным окном на озеро, финская сауна + русский пар, зона отдыха с диванами",
    price: "от 3 500 ₽/2 ч.",
    persons: "до 6 чел.",
    img: HERO_IMG,
    badge: "Хит",
  ...
  {
    name: "Баня 3",
    desc: "Баня-люкс с купелью и бассейном, беседка с мангалом, отдельный вход, идеально для компании",
    price: "от 5 000 ₽/2 ч.",
    persons: "до 10 чел.",
    img: ROOM_IMG,
    badge: "",
