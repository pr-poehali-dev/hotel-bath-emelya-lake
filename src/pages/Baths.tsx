...
const BATHS = [
  ...
  },
  {
    ...
    description: "Русская баня с большим дубовым чаном, установленным прямо под открытым небом среди леса. Горячая вода в чане пропитывается ароматами трав. Лежать в чане и смотреть на звёздное небо Башкирии — незабываемое ощущение.",
