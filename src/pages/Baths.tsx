...
const COTTAGE2_PHOTOS = [
  "https://cdn.poehali.dev/projects/3774030f-afe0-41fc-93b3-45b1a765fe14/bucket/d1255134-2eaa-4999-bca8-8749eccccf67.jpg",
...
const BATHS = [
  {
    ...
    description: "Просторная русская баня с большим чистым бассейном. Разогрейтесь до отказа в парной с берёзовым веником, а затем нырните в прохладную воду — это лучший способ восстановить силы после долгой дороги. Идеально для компании от 2 до 8 человек.",
    features: ["Дровяная печь", "Бассейн с чистой водой", "Предбанник с зоной отдыха", "Банные простыни"],
    prices: {
  ...
  },
  {
    ...
    shortDesc: "Просторный чан под открытым небом — особенная атмосфера.",
    description: "Русская баня с просторным чаном, в котором могут одновременно разместиться до 6 человек. Горячая вода в чане пропитывается ароматами трав. Лежать в чане и смотреть на звёздное небо Башкирии — незабываемое ощущение.",
    features: ["Дровяная печь", "Просторный чан до 6 человек", "Парная с берёзовым веником", "Открытая площадка", "Ароматные травяные сборы", "Банные простыни"],
    prices: {
  ...
  },
  {
    ...
    features: ["Дровяная печь", "Обливное ведро", "Парная с высоким жаром", "Предбанник с зоной отдыха", "Банные простыни"],
    prices: {
