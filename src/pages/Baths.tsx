...
const BATHS = [
  ...
  },
  {
    ...
    description: "Русская баня с просторным чаном, в котором могут одновременно разместиться до 6 человек, установленным прямо под открытым небом среди леса. Горячая вода в чане пропитывается ароматами трав. Лежать в чане и смотреть на звёздное небо Башкирии — незабываемое ощущение.",
    features: ["Дровяная печь", "Просторный чан до 6 человек", "Парная с берёзовым веником", "Открытая площадка", "Ароматные травяные сборы", "Полотенца и халаты"],
    prices: {
